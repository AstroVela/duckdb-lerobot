...
def create_reference_dataset(root: Path) -> None:
...
def create_duckdb_dataset(duckdb: Path, extension: Path, root: Path) -> None:
    features_json = (
    ...
    run_duckdb(
        ...
        f") TO {sql_quote(root)} (FORMAT lerobot, FPS 10, ROBOT_TYPE 'conformance', "
